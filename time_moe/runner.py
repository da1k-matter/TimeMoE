...
class TimeMoeRunner:
    ...
    def load_model(
        ...
        **kwargs,
        ...
        if attn is None:
            ...
            log_in_local_rank_0(
                "Flash Attention 2 is not available, switching to eager attention.",
                type="warn",
            )
            attn = "eager"
    ...
    def train_model(
        self, from_scratch: bool = False, val_data_path: str = None, **kwargs
    ):
        ...
        train_ds = self.get_train_dataset(
            ...
            target_cols=train_config.get("target_cols"),
        )
        eval_ds = None
